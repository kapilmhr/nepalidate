package app.frantic.dateconverter;
...
public class DateConverter {
    ...
    public String getNepDate(int year,int month,int day){
        int engYear = year;
        int engMonth = month;
        int engDay = day;
        ...
        calendar.clear();
        calendar.set(Calendar.MONTH, nepMonth);
        calendar.set(Calendar.YEAR, nepYear);
        calendar.set(Calendar.DAY_OF_MONTH, nepDay);
        Date date = calendar.getTime();
        Log.d("date",calendar.YEAR+" - "+calendar.DAY_OF_MONTH+" - "+calendar.DAY_OF_WEEK);
        Log.d("date222",date.toString());
        Log.d("date222",date.getMonth()+" ---");
        return nepYear+"-"+(nepMonth-1)+"-"+nepDay;
    }
    public int getNepYear(int year,int month,int day){
        int engYear = year;
        int engMonth = month;
        int engDay = day;
    ...
    public int getNepMonth(int year,int month,int day) {
        int engYear = year;
        int engMonth = month;
        int engDay = day;
        ...
        public int getNepDay(int year,int month,int day){
        int engYear = year;
        int engMonth = month;
        int engDay = day;
